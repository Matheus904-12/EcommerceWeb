...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['acao'])) {
    if ($_POST['acao'] == 'verificar_email') {
        ...
        header("Location: ../Site/login_site.php");
        exit();
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['acao']) && $_POST['acao'] == 'cadastrar') {
        ...
        if ($result->num_rows > 0) {
            ...
            $query = "INSERT INTO usuarios (name, email, password, endereco, cep, numero_casa, telefone, primeira_compra) VALUES (?, ?, ?, ?, ?, ?, ?, 1)";
            $stmt = $conn->prepare($query);
...
<head>
    ...
    <link rel="stylesheet" href="../Site/css/login/login.css">
...
<body>
        ...
        <div class="box">
            <div class="inner-box">
                <div class="forms-wrap">
                    <form action="../Site/includes/login/processa_login.php" method="POST" class="sign-in-form" id="sigin">
                        <div class="logo">
                        ...
                        <div class="actual-form">
                            ...
                            <br>
                            <button class="sign-btn" type="button" onclick="window.location.href = '../Site/google_login.php';">
                    ...
                    <form method="POST" autocomplete="off" class="sign-up-form" id="signup">
                        ...
                        <div class="step active" id="step1">
                            ...
                            <div class="input-wrap">
                                <input type="text" name="cpf" class="input-field" value="<?php echo $_POST['cpf'] ?? ''; ?>" required maxlength="14" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}">
                                <label>CPF</label>
                            </div>
                            <div class="input-wrap">
                            ...
                            <br>
                            <button type="button" class="next sign-btn">Próximo</button>
                        </div>
                ...
                <div class="carousel">
                    <div class="images-wrapper">
                        <img src="../Site/img/login/logogran.jpg" class="image img-1 show" alt="">
                        <!-- As outras imagens foram removidas para deixar apenas a primeira -->
                    </div>
    ...
    <script src="../Site/js/login/login.js"></script>
    ...
    <script>
        ...
        function showSuccessStep() {
            ...
            fetch('../Site/includes/login/processa_cadastro.php', {
                    method: 'POST',
                    body: formData
                })
                .then(response => {
        ...
        function finalizarCadastro() {
            ...
            fetch('../Site/includes/login/processa_login.php', {
                    method: 'POST',
                    body: formData
                })
                .then(response => {
        ...
        window.onload = function() {
            try {
                ...
                logToServer('Google client inicializado com sucesso');
            } catch (e) {
        ...
        document.querySelectorAll('.toggle-recovery').forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                fetch('../Site/login_site.php?reset_recuperacao=1', {
                    method: 'GET'
                });
            });
        });
