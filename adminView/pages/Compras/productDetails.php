                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <p class="mb-2">
                                    <span class="font-medium text-gray-300">Promoção:</span>
                                    <?php if (isset($produto['promocao']) && $produto['promocao'] == 1): ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">Promoção</span>
                                    <?php else: ?>
                            ...
                            <!-- Dimensões e Peso -->
                            <div class="mb-6">
                                <h3 class="text-lg font-medium text-gray-300 mb-2">Dimensões e Peso</h3>
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    <div class="bg-gray-700 p-3 rounded-md">
                                        <p class="text-sm text-gray-400">Comprimento</p>
                                        <p class="font-medium"><?= number_format($produto['comprimento'] ?? 0, 1) ?> cm</p>
                                    </div>
                                    <div class="bg-gray-700 p-3 rounded-md">
                                        <p class="text-sm text-gray-400">Largura</p>
                                        <p class="font-medium"><?= number_format($produto['largura'] ?? 0, 1) ?> cm</p>
                                    </div>
                                    <div class="bg-gray-700 p-3 rounded-md">
                                        <p class="text-sm text-gray-400">Altura</p>
                                        <p class="font-medium"><?= number_format($produto['altura'] ?? 0, 1) ?> cm</p>
                                    </div>
                                    <div class="bg-gray-700 p-3 rounded-md">
                                        <p class="text-sm text-gray-400">Peso</p>
                                        <p class="font-medium"><?= number_format($produto['peso'] ?? 2, 1) ?> kg</p>
                                    </div>
                                </div>
                            </div>
