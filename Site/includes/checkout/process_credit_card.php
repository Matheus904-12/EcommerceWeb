...
require_once __DIR__ . '/../../../Site/includes/config.php'; // Carregar variáveis de ambiente
...
try {
    ...
    // Configurações da Cielo - usando variáveis de ambiente
    $merchantId = getenv('CIELO_MERCHANT_ID') ?: 'SEU_MERCHANT_ID'; // Merchant ID do .env
    $merchantSecret = getenv('CIELO_MERCHANT_KEY') ?: 'SEU_MERCHANT_SECRET'; // Merchant Secret do .env
    $apiUrl = getenv('CIELO_API_URL') ?: 'https://apisandbox.cieloecommerce.cielo.com.br/1/sales'; // URL da API do .env
