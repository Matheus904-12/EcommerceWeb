                                ...
                                <?php foreach ($produtos as $produto): ?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <?php
                                            $basePath = 'uploads/produtos/';
                                            $nomeArquivo = pathinfo($produto['imagem'], PATHINFO_FILENAME);
                                            $extensao = pathinfo($produto['imagem'], PATHINFO_EXTENSION);
                                            $webpPath = $basePath . $nomeArquivo . '.webp';
                                            $originalPath = $basePath . $produto['imagem'];
                                            $temWebp = !empty($produto['imagem']) && file_exists($webpPath);
                                            $temOriginal = !empty($produto['imagem']) && file_exists($originalPath);
                                            ?>
                                            <picture>
                                                <?php if ($temWebp): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if ($temOriginal): ?>
                                                    <img src="<?= $originalPath ?>" width="100" height="400" alt="<?= htmlspecialchars($produto['nome']) ?>" class="img-thumbnail" style="max-height: 400px;">
                                                <?php else: ?>
                                                    <img src="assets/images/placeholder.png" width="80" height="80" alt="Sem imagem" class="img-thumbnail" style="max-height: 80px;">
                                                <?php endif; ?>
                                            </picture>
                                        </td>
