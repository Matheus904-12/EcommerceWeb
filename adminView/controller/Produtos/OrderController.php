    ...
    public function createOrder(array $orderData)
    {
        try {
            ...
            */
            ...
            // Exibe o erro do MySQL na tela para depuração
            die('<div style="color:red;background:#fffbe6;padding:20px;font-size:1.2em;">
                <b>ERRO MYSQL:</b> ' . htmlspecialchars($this->conn->error) . '<br>
                <b>EXCEPTION:</b> ' . htmlspecialchars($e->getMessage()) . '
            </div>');
            // (Opcional: mantenha o log para produção)
